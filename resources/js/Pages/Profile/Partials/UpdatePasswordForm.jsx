...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-bold text-white font-poppins">Update Password</h2>

                <p className="mt-1 text-sm font-light text-white font-poppins">
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    <PrimaryButton disabled={processing}className="font-poppins">Save</PrimaryButton>
