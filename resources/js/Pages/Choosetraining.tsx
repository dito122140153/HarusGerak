...
const ChooseTraining = () => {
    ...
    return (
        <div className="min-h-screen py-20 text-white px-72 bg-black/90">
            {/* Heading */}
            <div className="mb-8">
                ...
                <p className="mt-2 text-xl">
                    Feel The Burn And Blast <br /> Away Those Calories!
                </p>
            ...
            <div className="flex">
                {/* Left: Plan Overview */}
                <div className="w-2/3">
                    <h2 className="text-2xl font-bold text-[#E2F163]">
                        Plan Overview
                    </h2>
                    ...
                    <div className="max-w-2xl mt-4 space-y-4">
                        {/* Crunch */}
                        <a
                            href="https://www.youtube.com/shorts/ba8tr1NzwXU"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <div className="flex items-center p-4 rounded-lg bg-white/30">
                        ...
                        <div className="flex items-center p-4 rounded-lg bg-white/30">
                            <div className="flex-grow">
                                <h3 className="text-xl font-bold">Week 1</h3>
                                <p className="text-gray-400">
                                    Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua.
                ...
                <div className="relative w-1/3 pl-8">
                    {/* Weekly Schedule */}
                    <div className="relative p-4 mb-8 rounded-lg bg-white/30">
                        ...
                        {isModalOpen && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
                                <div className="w-1/3 p-8 text-center bg-gray-900 rounded-lg">
                                    <h3 className="mb-4 text-2xl font-bold text-[#E2F163]">
                                    ...
                                    <div className="grid grid-cols-7 gap-4 mb-8">
                                        {days.map((day, idx) => (
                                            ...
                                            >
                                                <button
                                                    className={`block w-8 h-8 mx-auto rounded-full border-2 ${
                                                        day.isCompleted
                                                            ? "border-lime-400"
                                                            : "border-gray-600"
                                                    }`}
                    ...
                    <div className="flex justify-between mt-20">
                        <div className="text-center">
                            <div className="flex flex-col items-center justify-center w-20 h-20 p-2 rounded-lg bg-white/30">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="32"
                                    height="32"
